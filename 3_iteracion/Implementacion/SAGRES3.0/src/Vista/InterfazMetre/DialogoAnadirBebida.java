...
public class DialogoAnadirBebida extends java.awt.Dialog {
    ...
    private void initComponents() {
        ...
        pMargenArr1 = new javax.swing.JPanel();
        pMargenArr2 = new javax.swing.JPanel();
        ...
        pNombre.setLayout(new java.awt.BorderLayout());
        ...
        pNombre.add(pMargenArr, java.awt.BorderLayout.NORTH);

        cuerpo.add(pNombre, java.awt.BorderLayout.NORTH);

        pAtributoCantidad.setBackground(new java.awt.Color(255, 255, 255));
        pAtributoCantidad.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(211, 223, 253)), "Cantidades", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 18), new java.awt.Color(150, 172, 229))); // NOI18N
        ...
        cuerpo.add(pAtributoCantidad, java.awt.BorderLayout.CENTER);
        ...
        cuerpo.add(pImagen, java.awt.BorderLayout.SOUTH);

        pMargenArr1.setOpaque(false);
        cuerpo.add(pMargenArr1, java.awt.BorderLayout.WEST);

        pMargenArr2.setOpaque(false);
        cuerpo.add(pMargenArr2, java.awt.BorderLayout.EAST);
    ...
    private javax.swing.JPanel pMargenArr1;
    private javax.swing.JPanel pMargenArr2;

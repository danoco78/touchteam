...
public class panelPedido extends javax.swing.JPanel {
    ...
    public panelPedido(ElementoPedido p) {
        initComponents();
        this.setLabelElemento(String.valueOf(p.getCodElementoPedido()));
    ...
    private void initComponents() {
        ...
        add(labelElemento, java.awt.BorderLayout.CENTER);

        labelObservacion.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        add(labelObservacion, java.awt.BorderLayout.PAGE_START);
        add(panelNorte, java.awt.BorderLayout.NORTH);
        add(panelCentral, java.awt.BorderLayout.PAGE_END);

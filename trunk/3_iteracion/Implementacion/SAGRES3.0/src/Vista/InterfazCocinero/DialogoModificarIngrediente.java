...
public class DialogoModificarIngrediente extends javax.swing.JDialog {
   ...
   /* private IProducto almacenProductos;
    ...
    private void initComponents() {
        ...
        pCentro.setLayout(new java.awt.BorderLayout(0, 10));

        pNombre.setOpaque(false);
        pNombre.setLayout(new java.awt.BorderLayout(5, 0));
        ...
        pCentro.add(pNombre, java.awt.BorderLayout.NORTH);

        pAbajo.setOpaque(false);
        pAbajo.setLayout(new java.awt.GridLayout(0, 1));
        ...
        lDisponible.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        lDisponible.setForeground(new java.awt.Color(80, 98, 143));
        lDisponible.setText("<html><body>Disponible<br> actualmente</body></html>");
        ...
        pCentro.add(pAbajo, java.awt.BorderLayout.CENTER);

 ...
 * @author Daniel
 */
public class DialogoEliminarUnElemento extends java.awt.Dialog {

    /** Creates new form DialogoAnadirElemento */
    public DialogoEliminarUnElemento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoEliminarUnElemento dialog = new DialogoEliminarUnElemento(new java.awt.Frame(), true);
